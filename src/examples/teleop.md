# Example Teleop
This is an example teleop taken from the [Pedro Pathing Beginner Quickstart](https://github.com/Pedro-Pathing-Projects/Beginner-Quickstart)

It serves as a **template** for a robot-centric teleop.
It can also be viewed [here](https://github.com/Pedro-Pathing-Projects/Beginner-Quickstart/blob/master/TeamCode/src/main/java/org/firstinspires/ftc/teamcode/opmode/example/ExampleTeleop_RobotCentric.java) on Github
